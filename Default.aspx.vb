...
#Region " Web Form Designer Generated Code "
    ...
    Public item As SummarizeSentence
    Public WithEvents SummarizeSentences As Generic.List(Of SummarizeSentence)
    ...
    Private Property Summarize As Object
...
"fo WHERE (TreeID = 2)"
        ...
        "layStopAt, InfoID) VALUES (@NodeID, @TypeID, @Picture, @Title, @PictureSize, @DisplayAt," & _
        " @DisplayStopAt, @InfoID); SELECT PictureID, NodeID, TypeID, Picture, Title, PictureSize," & _
        " DisplayAt, DisplayStopAt, InfoID FROM Pictures WHERE (PictureID = @@IDENTITY)"
        ...
        Me.SqlInsertCommand4.Parameters.Add(New System.Data.SqlClient.SqlParameter("@InfoID", System.Data.SqlDbType.Int, 4, "InfoID"))
        ...
        "DisplayStopAt InfoID = @InfoID WHERE (PictureID = @Original_PictureID) AND (DisplayAt = @Original" & _
        ...
        "Size) AND (Title = @Original_Title) AND (TypeID = @Original_TypeID) AND (InfoID = @Original_InfoID); SELECT Pict" & _
        "ureID, NodeID, TypeID, Picture, Title, PictureSize, DisplayAt, DisplayStopAt, InfoID FRO" & _
        ...
        Me.SqlUpdateCommand4.Parameters.Add(New System.Data.SqlClient.SqlParameter("@InfoID", System.Data.SqlDbType.Int, 4, "InfoID"))
        ...
        Me.SqlUpdateCommand4.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_InfoID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "InfoID", System.Data.DataRowVersion.Original, Nothing))
        ...
        "ictureSize) AND (Title = @Original_Title) AND (TypeID = @Original_TypeID) AND (InfoID = @O" & _
        "riginal_InfoID)"
        ...
        Me.SqlDeleteCommand4.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_InfoID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "InfoID", System.Data.DataRowVersion.Original, Nothing))
        '
        'daPictures
        '
        ...
        Me.daPictures.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "Pictures", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("PictureID", "PictureID"), New System.Data.Common.DataColumnMapping("NodeID", "NodeID"), New System.Data.Common.DataColumnMapping("TypeID", "TypeID"), New System.Data.Common.DataColumnMapping("Picture", "Picture"), New System.Data.Common.DataColumnMapping("Title", "Title"), New System.Data.Common.DataColumnMapping("PictureSize", "PictureSize"), New System.Data.Common.DataColumnMapping("DisplayAt", "DisplayAt"), New System.Data.Common.DataColumnMapping("DisplayStopAt", "DisplayStopAt"), New System.Data.Common.DataColumnMapping("InfoID", "InfoID")})})
...
#End Region
    ...
    Private Sub btnBackOut_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnBackOut.Click
        ...
        Else
            ...
            btnGo.Enabled = False
        End If
        txtNodeText.Visible = True
        txtSummText.Visible = False
        txtSummText.Enabled = False
        gvSummarize.Visible = False
        gvSummarize.Enabled = False
        btnNewSummary.Enabled = True
        btnNewSummary.Visible = True
        drpSummaries.Enabled = False
        lblPercentReduction.Visible = False
        Notes.BackOut()
        SetViewStates("NodeTextOperation")
    End Sub
    ...
    Protected Sub btnNewSummary_Click(sender As Object, e As ImageClickEventArgs) Handles btnNewSummary.Click
        ...
        btnSave.ImageUrl = "images\Icons\Save_Disabled.png"
        txtNodeText.Visible = False
        gvSummarize.Visible = True
        gvSummarize.Enabled = True
        lblPercentReduction.Visible = True
    ...
    Private Sub btnSaveSummary_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSaveSummary.Click
        ...
        gvSummarize.Visible = False
        gvSummarize.Enabled = False
        btnNewSummary.Enabled = False
        drpSummaries.Enabled = False
        lblPercentReduction.Visible = False
        rdoLargeSumm.Checked = False
        rdoLargeSumm.Enabled = True
        rdoLargestSumm.Checked = False
        rdoLargestSumm.Enabled = True
        rdoSmallSumm.Checked = True
        rdoSmallSumm.Enabled = True
        txtSummText.Height = System.Web.UI.WebControls.Unit.Pixel(85)
        btnBackOut.ImageUrl = "images\Icons\No_Disabled.png"
        btnBackOut.Enabled = False
        drpSummaries.ClearSelection()
    ...
    Private Sub BindGridView()
        Dim dtSummarize As DataTable
        Dim dvSummarize As DataView
        Dim lastParagraph, currParagraph As Integer
        'If (ViewState("dtSummarize") <> Nothing) Then
        ' Get the DataTable from ViewState.
        dtSummarize = DirectCast(ViewState("dtSummarize"), DataTable)
        ...
        'Create Summary
        lastParagraph = 0
        txtSummText.Text = "Summary: " + txtHeading.Text + Chr(13) + Chr(10) + Chr(13) + Chr(10)
        For Each row In dtSummarize.Rows
            currParagraph = row("Paragraph")
            If currParagraph <> lastParagraph Then
                lastParagraph = currParagraph
                If row("Include") Then
                    txtSummText.Text += row("Sentence")
                End If
            Else
                If row("Include") Then
                    txtSummText.Text += row("Sentence")
            ...
            End If
        Next
        lblPercentReduction.Text = "Summary text reduction is : " + ((100 - CInt((txtSummText.Text.Length / txtNodeText.Text.Length) * 100))).ToString() + " %"
    End Sub
    ...
    Private Sub InitializeDataSource()
        Dim dtSummarize As DataTable
        Dim dcSummarize(1) As DataColumn
        Dim ssm As SummarizeSentenceManager
        Dim SummSentences As Generic.List(Of SummarizeSentence)
        Dim ssmText As String
        ' Create a DataTable object named dtSummarize.
        dtSummarize = New DataTable()
        ' Add four columns to the DataTable.
        Dim Incl As New DataColumn("Include", GetType(Boolean))
        Dim Para As New DataColumn("Paragraph", GetType(Integer))
        Dim SentNo As New DataColumn("SentenceNo", GetType(Integer))
        Dim Sent As New DataColumn("Sentence", GetType(String))
        ...
        'Get the Text
        SummSentences = New Generic.List(Of SummarizeSentence)
        ssmText = txtNodeText.Text
        ssm = New SummarizeSentenceManager(ssmText)
        For Each Sentence In ssm.Sentences
            SummSentences.Add(Sentence)
    ...
    Protected Sub gvSummarize_PageIndexChanging(sender As Object, e As GridViewPageEventArgs) Handles gvSummarize.PageIndexChanging
    ...
    Protected Sub gvSummarize_RowEditing(sender As Object, e As GridViewEditEventArgs) Handles gvSummarize.RowEditing
    ...
    Protected Sub gvSummarize_RowUpdated(sender As Object, e As GridViewUpdatedEventArgs) Handles gvSummarize.RowUpdated
        Dim i As Integer
        i = 1
    End Sub

    Protected Sub gvSummarize_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvSummarize.SelectedIndexChanged
        Dim i As Integer
        i = 1
    End Sub

    Protected Sub gvSummarize_RowUpdating(sender As Object, e As GridViewUpdateEventArgs) Handles gvSummarize.RowUpdating
        Dim dtSummarize As DataTable
        Dim drSummarize As DataRow
        Dim SentenceNo As Integer
        Dim cntl, cntl1 As CheckBox
        ' Get the DataTable from ViewState.
        dtSummarize = DirectCast(ViewState("dtSummarize"), DataTable)
        ' Get the Index of the selected row.
        SentenceNo = CInt(gvSummarize.Rows(e.RowIndex).Cells(3).Text)
        ...
        cntl = DirectCast(gvSummarize.Rows(SentenceNo Mod gvSummarize.PageSize).FindControl("CheckBox1"), CheckBox)
    ...
    Protected Sub gvSummarize_RowCancelingEdit(sender As Object, e As GridViewCancelEditEventArgs) Handles gvSummarize.RowCancelingEdit
        Dim i As Integer
        i = 1
        ' Exit edit mode.
        gvSummarize.EditIndex = -1
    ...
    Protected Sub gvSummarize_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles gvSummarize.SelectedIndexChanging
        Dim i As Integer
        i = 1
    End Sub

    Protected Sub btnSummary_Click(sender As Object, e As ImageClickEventArgs) Handles btnSummary.Click
        Dim Summaries As String
        Dim RecordID As Integer
        Dim dr As DataRow
        Dim drFound() As DataRow
        Dim SelectExpression As String
        Dim ChapterSummNode As Integer
        Summaries = ""
        ChapterSummNode = -1
        Notes.SpanBranch(Summaries, Notes.SelectedNode, ChapterSummNode)
        If ChapterSummNode <> -1 Then
            SelectExpression = "NodeID = " & ChapterSummNode
            drFound = dsNodes.Tables(0).Select(SelectExpression)
            dr = drFound(0)
            dr("Heading") = "Chapter Summary"
            dr("NodeText") = Summaries
            daNodes.Update(dsNodes.Tables(0))
        Else
            'Create the new node
            dr = dsNodes.Tables(0).NewRow()
            dr("TreeID") = 2
            dr("TypeID") = 5
            dr("TreeLevel") = Notes.CurrentLevel + 1
            dr("ParentNodeID") = Notes.SelectedNode
            dr("Heading") = "Chapter Summary"
            dr("NodeText") = Summaries
            dsNodes.Tables(0).Rows.Add(dr)
            daNodes.Update(dsNodes.Tables(0))
            RecordID = dr("NodeID")
        End If
        ' Selected Node becomes Parent
        Notes.ParentNode = Notes.SelectedNode
        ' Going down a level
        Notes.CurrentLevel = Notes.CurrentLevel + 1
        ' Get 1st child, if there werent any the down button would have been disabled
        SelectExpression = "ParentNodeID = " & Notes.ParentNode
        drFound = dsNodes.Tables(0).Select(SelectExpression)
        dr = drFound(0)
        ' the new selected node
        If ChapterSummNode <> -1 Then
            Notes.SelectedNode = ChapterSummNode
        Else
            Notes.SelectedNode = RecordID
        End If
